    ...
    <div className="w-full max-w-md">
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-6 shadow-[0_30px_70px_-42px_rgba(15,23,42,0.55)] sm:p-8">
        ...
        <p className="mt-1 text-[13px] text-text-2">
          Tez üretmek ve watchlist&apos;e sembol eklemek için giriş yapın.
        </p>
            ...
            input={
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="h-11 w-full rounded-lg border border-border bg-slate-50 px-3 pr-10 text-[14px] text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none focus:ring-[3px] focus:ring-primary/20 dark:bg-muted dark:text-white"
                />
                <button
                  type="button"
...
function AuthFallback() {
  return (
    <div className="h-[420px] w-full max-w-md animate-pulse rounded-2xl border border-border bg-card/60" />
  );
}
