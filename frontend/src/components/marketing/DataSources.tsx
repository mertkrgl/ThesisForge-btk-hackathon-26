...
export function DataSources() {
  return (
    <section
      id="kaynaklar"
      className="relative border-b border-line/60 bg-[#070A12]"
    >
      <div className="mx-auto w-full max-w-[1280px] px-6 py-16">
        <div className="flex flex-col items-center gap-2 text-center">
          <span className="text-[10.5px] font-semibold uppercase tracking-[0.18em] text-[#93C5FD]">
            Veri Kaynakları
          </span>
          <h3 className="text-balance text-xl font-bold text-white md:text-2xl">
        ...
        <ul className="mt-10 grid grid-cols-2 gap-3 md:grid-cols-4">
          {SOURCES.map((s) => {
            ...
            return (
              ...
              >
                <div className="grid h-10 w-10 place-items-center rounded-lg border border-line bg-[#0F1A30] text-[#93C5FD]">
