...
export function HowItWorks() {
  return (
    <section
      id="nasil-calisir"
      className="relative border-b border-line/60 bg-[linear-gradient(180deg,#070A12,#0B1220)]"
    >
        ...
        <ol className="relative mt-14 grid grid-cols-1 gap-5 md:grid-cols-4">
          ...
          {STEPS.map((step, i) => {
            ...
            return (
              <li
                key={step.title}
                className="relative rounded-2xl border border-line bg-card/60 p-5"
              >
                <div className="flex items-center gap-3">
                  <div className="grid h-[52px] w-[52px] place-items-center rounded-xl border border-line bg-[#0F1A30] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)]">
