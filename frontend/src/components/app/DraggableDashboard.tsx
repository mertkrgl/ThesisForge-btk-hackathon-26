      ...
      {width > 0 && (
        ...
        >
          <div key="pulse" className="relative group">
            <div className="drag-handle absolute top-4 right-4 z-10 cursor-move opacity-0 group-hover:opacity-100 transition-opacity bg-[#0C1428] rounded border border-white/10 p-1 text-white/50 hover:text-white">
