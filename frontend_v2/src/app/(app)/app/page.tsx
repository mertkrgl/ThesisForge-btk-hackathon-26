    ...
    <div className="mx-auto w-full max-w-[1440px] px-6 py-8">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-5">
        ...
        >
          ...
          Yeni Tez
          <span className="ml-1 rounded border border-slate-200 bg-blue-100 px-1 py-px font-mono text-[10px]">
            ⌘N
          </span>
        </Link>
      </div>
      ...
      <div className="mt-6">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-[14px] font-semibold text-slate-900">Son Tezler</h2>
          <Link
            href="/app/history"
