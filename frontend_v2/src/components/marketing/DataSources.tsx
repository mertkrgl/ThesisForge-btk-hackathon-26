    ...
    >
      <div className="mx-auto w-full max-w-[1280px] px-6 py-16">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h3 className="text-balance text-xl font-bold text-slate-900 md:text-2xl">
        ...
        <ul className="mt-10 grid grid-cols-2 gap-3 md:grid-cols-4">
          {SOURCES.map((s) => {
            ...
            return (
              ...
              >
                <div className="grid h-10 w-10 place-items-center rounded-lg border border-slate-200 bg-blue-50 text-blue-600">
