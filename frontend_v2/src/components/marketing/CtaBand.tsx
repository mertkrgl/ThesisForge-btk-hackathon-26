    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-[1280px] px-6 py-24 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/app/thesis/new"
            className="inline-flex h-11 items-center gap-2 rounded-lg border border-slate-200 bg-white px-5 text-[13.5px] font-medium text-slate-600 transition-colors hover:border-slate-300 hover:text-slate-900"
          >
            Demo Tezi Çalıştır
          </Link>
        </div>
