      ...
      <div className="mx-auto flex h-[64px] w-full max-w-[1280px] items-center gap-6 px-6">
          ...
          {NAV.map((item) => {
            ...
            return (
              <a
                key={item.href}
                href={item.href}
                className={`rounded-md px-3 py-1.5 text-[13px] font-medium transition-colors hover:bg-slate-100 hover:text-slate-900 ${
        ...
        <div className="ml-auto flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden h-9 items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 text-[12.5px] font-medium text-slate-600 transition-colors hover:border-slate-300 hover:text-slate-900 sm:inline-flex"
          >
