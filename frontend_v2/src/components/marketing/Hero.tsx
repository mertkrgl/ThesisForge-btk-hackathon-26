    ...
    <section className="relative overflow-hidden border-b border-line/60">
      ...
      <div className="relative mx-auto grid w-full max-w-[1280px] gap-12 px-6 pb-20 pt-16 md:grid-cols-[1.05fr_1fr] md:pb-28 md:pt-24">
        <div className="flex flex-col">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-[11px] font-medium text-slate-500">
          ...
          <h1 className="mt-5 text-balance text-4xl font-extrabold leading-[1.05] tracking-tight md:text-[64px]">
            <span className="block text-slate-900">8 ajanlı yapay zekâ</span>
          ...
          <p className="mt-5 max-w-xl text-[14.5px] leading-relaxed text-text-2">
            ...
            <span className="text-slate-900 font-semibold">bull/bear/katalist</span> tezi
            üretir; her cümlenin altında kaynak, her tezin yanında bir{" "}
            <span className="text-slate-900 font-semibold">güven skoru</span> bulunur. Sinyal
          ...
          <div className="mt-7 flex flex-wrap items-center gap-3">
            ...
            <a
              href="#nasil-calisir"
              className="inline-flex h-11 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-[13.5px] font-medium text-slate-600 transition-colors hover:border-slate-300 hover:text-slate-900"
            >
          ...
          <dl className="mt-10 grid max-w-md grid-cols-3 gap-6 border-t border-line/60 pt-6">
...
function HeroDemoFallback() {
  return (
    <div className="glass relative w-full overflow-hidden rounded-2xl p-5">
      ...
      <div className="mt-5 h-[280px] rounded-xl border border-dashed border-slate-200 bg-slate-50" />
    </div>
  );
}
