...
export function ThesisCard({ thesis }: { thesis: Thesis }) {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col rounded-2xl border border-line bg-white shadow-sm p-4 transition-all hover:-translate-y-0.5 hover:border-line-2 hover:shadow-[0_20px_40px_-20px_rgba(59,130,246,0.35)]"
    >
