...
export function MarketPulse() {
  ...
  const option = {
    ...
    tooltip: {
      ...
      borderColor: "#E2E8F0",
      textStyle: { color: "#0F172A", fontSize: 11, fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace" },
    },
    series: [
      {
        type: "candlestick",
  ...
  if (flashColor === "up") bgClass = "bg-[#089981]/10";
  if (flashColor === "down") bgClass = "bg-[#f23645]/10";
