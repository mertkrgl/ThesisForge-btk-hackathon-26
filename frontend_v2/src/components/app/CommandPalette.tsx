...
export function CommandPalette({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-[min(640px,92vw)] overflow-hidden rounded-2xl border border-line bg-white/95 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] glass-strong tf-rise">
        <div className="flex items-center gap-2 border-b border-line px-4 py-3">
          ...
          <input
            ...
            className="flex-1 bg-transparent text-[14px] text-slate-900 placeholder:text-muted-foreground focus:outline-none"
          />
