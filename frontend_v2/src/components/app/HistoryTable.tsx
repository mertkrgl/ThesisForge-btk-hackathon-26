  ...
  return (
    <div className="rounded-2xl border border-line bg-card">
      <div className="flex flex-wrap items-center gap-3 border-b border-line px-4 py-3">
        <div className="flex w-[280px] items-center gap-2 rounded-lg border border-line bg-slate-50 px-2.5 py-1.5 text-[13px] focus-within:border-primary focus-within:shadow-[0_0_0_3px_rgba(59,130,246,0.15)]">
            ...
            <button
              ...
              className={cn(
                ...
                filter === f.id
                  ...
                  : "border-line bg-white text-text-2 hover:border-line-2 hover:text-slate-900"
              )}
            >
              {f.label}
            </button>
        ...
        <table className="w-full text-left text-[12.5px]">
          ...
          <tbody>
            {rows.map((t) => (
              <tr
                key={t.id}
                className="border-b border-line/60 transition-colors hover:bg-slate-50"
              >
                <td className="px-4 py-3">
                  <Link
                    href={`/app/thesis/${t.id}`}
                    className="font-mono text-[13px] font-semibold text-slate-900 hover:text-[#93C5FD]"
                  >
                    {t.ticker}
                  </Link>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono text-[11.5px] font-semibold text-slate-900">
                      {t.confidence}%
                    </span>
                  </div>
                </td>
                ...
                <td className="px-4 py-3 text-right">
                  <Link
                    href={`/app/thesis/${t.id}`}
                    className="text-[11.5px] text-[#93C5FD] hover:text-slate-900"
                  >
                    Aç →
                  </Link>
                </td>
