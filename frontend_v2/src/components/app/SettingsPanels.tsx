    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-[240px_1fr]">
        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              onClick={() => setTab(t.id)}
              className={cn(
                "flex items-center gap-2.5 rounded-lg px-3 py-2 text-left text-[13px] text-text-2 transition-all hover:bg-slate-100 hover:text-slate-900",
                active &&
                  "bg-blue-50 text-slate-900 shadow-[inset_0_0_0_1px_#1E2A44,inset_2px_0_0_#3B82F6]"
              )}
            >
      ...
      <div className="rounded-2xl border border-line bg-card p-6">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    settings.model === m
                      ...
                      : "border-line bg-slate-50 hover:border-line-2"
                  )}
                >
        ...
        {tab === "data" && (
          ...
          >
            <ul className="divide-y divide-line/60 rounded-xl border border-line bg-slate-50">
              {[
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between gap-3 rounded-lg border border-line bg-slate-50 px-4 py-3">
