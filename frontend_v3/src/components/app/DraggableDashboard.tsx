      ...
      {width > 0 && (
        ...
        >
          <div key="pulse" className="relative group">
            <div className="drag-handle absolute top-4 right-4 z-10 cursor-move opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-card rounded border border-slate-200 dark:border-white/10 p-1 text-slate-400 dark:text-white/50 hover:text-slate-900 dark:hover:text-white">
